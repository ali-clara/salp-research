...
def trim_data(data_list, trim_to=None):
    if trim_to is None:
...
if __name__ == "__main__":
    ...
    if plot_force:
        force_means, force_stdvs, times = load_and_compile(force_folder_path)
